...
const TOKENS = {
    ORBIT: {
        ...
        // ⬇️ Stronger outlines in Orbit
        ring: 'rgba(148,163,184,0.22)',
        ink: '#E5E7EB',
        sub: '#94A3B8',
        panelBg:
            'linear-gradient(180deg, rgba(20,26,48,0.96) 0%, rgba(14,19,36,0.96) 60%, rgba(12,17,30,0.96) 100%)',
        // ⬇️ Darker, richer card background to increase contrast in the sidebar
        cardGrad:
        ...
        link: '#C7D2FE',
        // ⬇️ Darker row surfaces for nav items (kept as colors because Tailwind uses bg-color here)
...
function applyVars(orbit: boolean): void {
